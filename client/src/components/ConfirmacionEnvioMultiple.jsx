...
const ConfirmacionEnvioMultiple = () => {
    const params = useParams();
    const [confirmacion, setConfirmacion] = useState('');
    const getDetallesProducto = () => {
        axios.get(`http://localhost:5000/confirmacion-envio-multiple/${params.id}`)
            .then((response) => {
    ...
    const notify = () => toast("Has comprado los artículos que había en tu carrito.");
...
export default ConfirmacionEnvioMultiple; 